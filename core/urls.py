...
from products.views import products_view, product_view, product_add_view, product_delete_view, product_edit_view, product_confirm_delete, products_category_view
